...
/**
 * Definition of all websocket states used to parse websocket frame format
 * 
...
public class WebSocketStates {
	 ...
	 */
	public final static int FIN_STATE = 1;
	 ...
	 */
	public final static int RSV_STATE = 2;
	 ...
	 */
	public final static int OPCODE_STATE = 3;
	 ...
	 * set to 1.
	 */
	public final static int MASK_STATE = 4;
	 ...
	 */
	public final static int PAYLOAD_LENGTH_2_BYTES = 6;

	/**
	 * state for payload length of 8 bytes size
	 */
	public final static int PAYLOAD_LENGTH_8_BYTES = 7;
	 ...
	 */
	public final static int MASKING_KEY = 8;
	 ...
	 * "Application data".
	 */
	public final static int PAYLOAD_DATA = 9;
	 ...
	 */
	public final static int EXTENSION_DATA = 10;
	 ...
	 */
	public final static int APPLICATION_DATA = 11;

	/**
	 * State for end of loading data (process can start)
	 */
	public final static int FINISHED_LOADING = 12;
}
